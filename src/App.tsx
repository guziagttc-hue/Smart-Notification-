...
export default function App() {
  return (
    <div className="bg-gray-100 flex justify-center items-center min-h-dvh font-bengali">
      <div className="relative w-full max-w-[390px] h-dvh max-h-[844px] bg-[#F4F6FA] shadow-2xl overflow-hidden border-[8px] border-gray-800 flex flex-col justify-between">
